...
urlpatterns = [
    ...
    path('password/send', request.send_reset_code_view, name='user_center_send_reset_code'),  # 发送重置密码验证码
    path('password/reset', request.reset_password_view, name='user_center_reset_password'),   # 重置密码
