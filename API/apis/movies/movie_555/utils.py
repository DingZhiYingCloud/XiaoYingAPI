...
- 与爬虫对外方法一一对应：categories / home / list / detail / play / search
"""
...
def get_list(type_id, page=1, order=None, year=None):
    """
    获取分类列表。

    :param type_id: 分类 id（1=电影 2=连续剧 3=综艺纪录 4=动漫，或榜单 id）
    :param page: 页码，从 1 开始
    :param order: 排序方式 time/hits/score（与 year 互斥，year 优先）
    :param year: 年份筛选
    """
    return _run("获取列表", lambda s: s.get_list(type_id, page=page, order=order, year=year))
